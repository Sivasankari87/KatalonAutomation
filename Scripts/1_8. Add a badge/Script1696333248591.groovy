...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Indigo Group Platform/input_Email Address_mat-input-1'), '4jUOjphFI3EBA93Ryq8d2Q==')
...
WebUI.setText(findTestObject('Object Repository/Page_Indigo Group Platform/input_Email Address_mat-input-1'), 'Optisol@2021')
...
WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/div_Contractors  List'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/mat-icon_more_vert'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/span_Add Badge'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/span_Password_mat-checkbox-inner-container'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/span_Save'))
