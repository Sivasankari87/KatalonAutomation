...
WebUI.click(findTestObject('Object Repository/Page_Admin Portal - Gatsby/a_2'))

WebUI.click(findTestObject('Object Repository/Page_Admin Portal - Gatsby/ngb-highlight_Siva SankariD'))
