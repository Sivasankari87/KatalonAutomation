...
WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/div_Marquee Contracting Limited'))
...
WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/a_Profile'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/mat-icon_close'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/strong_Marquee Contracting Limited'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/span_Hub'))
