...
WebUI.setText(findTestObject('Object Repository/Page_Driver Portal - Gatsby/input_Email Address_Email Address'), 'sankariselvamuma+sep28dr2@gmail.com')
...
WebUI.click(findTestObject('Object Repository/Page_Drivers Portal - Gatsby/span_Sign Out'))
