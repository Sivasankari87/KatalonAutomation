...
WebUI.setText(findTestObject('Object Repository/Page_Indigo Group Platform/input_Use the form below to log in to your _c66cd7'), 
    'sivasankari.s@optisolbusines.com')
...
WebUI.setText(findTestObject('Object Repository/Page_Indigo Group Platform/input_Check Companies House_mat-input-3'), 'marquee opera')

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/div_Marquee Operations Limited'))
...
WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/strong_Marquee Operations Limited'))

WebUI.click(findTestObject('Object Repository/Page_Indigo Group Platform/button_homeHub'))
